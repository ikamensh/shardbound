...
CREDITS
Game and Saga2D framework: Ilya Kamenshchikov and contributors, under the MIT license. Original art, music and sound cues are generated by the project's own drawing and synthesis code. Eador inspired the gameplay research; Shardbound is an independent game. CPython, pyglet, Pillow, NumPy and websockets power the application. Packaged builds include their license texts and the PyInstaller bootloader license under release/licenses.
