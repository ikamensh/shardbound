...
class SettingsScene(Screen):
    ...
    def draw(self):
        ...
        if self.page == "display" and not self.load_error:
            notice = "Reading size: title, Codex, Guide, briefings, Build, Recruit, replacement, Hero, choices, results, Saves, rival and campaign plans, campaign transitions, battle objectives and forecasts.\nTab: page · Up/Down: row · Left/Right: value."
