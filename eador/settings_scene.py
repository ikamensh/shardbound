...
class SettingsScene(Screen):
    ...
    def draw(self):
        ...
        if self.page == "display" and not self.load_error:
            notice = "Reading size: title, Codex, Guide, briefings, purchases, Hero, choices, results, saves/messages, campaign screens, map facts, battle objectives, unit facts, forecasts, guidance and log.\nTab: page · Up/Down: row · Left/Right: value."
