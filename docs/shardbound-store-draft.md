...
| Shared-realm online and LAN co-op | `eador/multiplayer.py`; `saga2d/online_menu.py`; [online guide](online-multiplayer.md) | Shared control of one army, not competitive play or a server-availability guarantee. |
