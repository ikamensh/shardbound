...
| Shared-realm online and LAN co-op | `eador/multiplayer.py`; `saga2d/multiplayer_ui.py`; [online guide](../../tribes/docs/online-multiplayer.md) | Shared control of one army, not competitive play or a server-availability guarantee. |
