...
procedural art and synthesized music and effects, a development icon and
system fonts. Multiplayer, diplomacy and an astral metacampaign are absent.

## Internal claim audit — not store copy

Reviewed against the source worktree on 2026-09-06. This audit identifies
...
| Original procedural art and synthesized audio | `eador/art.py`; `eador/sound.py`; `eador/assets/AUDIO-PROVENANCE.md` | No copied commercial artwork or branding is proposed for the listing. Listening quality is still unverified. |
